...
def main():
    ...
    # ADD YOUR CODE HERE
    print(f"Saving acct: interest earned  = ${interest_earned:.2f}")
    print(f"Saving acct: new balance  = ${updated_savings_balance:.2f}")
    ...
    # ADD YOUR CODE HERE
    print(f"CD acct: interest earned  = ${interest_earned:.2f}")
    print(f"CD acct: new balance  = ${updated_cd_balance:.2f}")
